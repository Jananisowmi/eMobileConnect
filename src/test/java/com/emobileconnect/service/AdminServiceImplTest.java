...
public class AdminServiceImplTest {
	...
	@Test
	public void testupdateRequestStatus() throws CommonException {
	...
	@Test
	public void testupdateRequestStatusInvalidAdminId() throws CommonException {
		when(adminRepository.findById(Mockito.anyInt())).thenReturn(Optional.empty());
		
		Optional<ResponseDto> response = adminServiceImpl.updateRequestStatus(REQUEST_ID, requestStatusUpdateDto);
		
		  Assertions.assertThrows(CommonException.class, () -> response.get());
	}
	
	@Test
	public void testupdateRequestStatusInvalidRequestId() throws CommonException {
		when(adminRepository.findById(Mockito.anyInt())).thenReturn(Optional.of(admin));
	...
	@Test
	public void testupdateRequestStatusInvalidStatus() throws CommonException {
		when(adminRepository.findById(Mockito.anyInt())).thenReturn(Optional.of(admin));
		when(requestTrackRepository.findById(Mockito.anyInt())).thenReturn(Optional.of(request));
